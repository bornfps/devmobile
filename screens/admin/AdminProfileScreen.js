...
export default function AdminProfileScreen() {
  ...
  const save = () => {
    ...
    Alert.alert('Perfil atualizado', 'Dados do administrador atualizados com sucesso.');
  };

  return (
    <ScreenContainer>
      <Text style={{ color: colors.text, fontSize: 22, fontWeight: '800' }}>Perfil do administrador</Text>
